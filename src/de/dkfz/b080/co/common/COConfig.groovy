...
class COConfig {
    ...
    public boolean getExtractSamplesFromInputTable() {
        return inputTableFile as boolean
    }

    public String getInputTableFile() {
        return configValues.getString(CVALUE_INPUT_TABLE, "")
    }

    public String getInputTableFormat() {
        return configValues.getString(CVALUE_INPUT_TABLE_FORMAT, "TSV")
    }
